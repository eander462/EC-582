...
```{r}
# Load packages
pacman::p_load(tidyverse, magrittr, here, haven, magrittr, AER, fixest, cragg, ivmodel)
...
The authors prefered log mortality because it has an easier interpretation than this level of mortality. 
...
The Wu-Hausaman test is significant so we conclude the instruments are exogenous.
